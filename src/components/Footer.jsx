  ...
  return (
    <div className='bg-[#263238] py-20'>
      <div className='container mx-auto max-w-[1320px]'>
        <div className='grid grid-cols-1 m-10 m:m-0 md:grid-cols-2'>
          <div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3'>
            <div>
              ...
              <ul className='flex flex-col mb-5'>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">About us</a></li>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">Blog</a></li>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">Contact us</a></li>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">Pricing</a></li>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">Testimonials</a></li>
              </ul>
            </div>
            <div>
              <h4 className='text-[1.25rem] text-white font-semibold'>Support</h4>
              <ul className='flex flex-col mb-5'>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">Help center</a></li>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">Terms of service</a></li>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">Legal</a></li>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">Privacy policy</a></li>
                <li className='mt-2'><a className='text-white text-[14px]' href="#">Status</a></li>
              </ul>
            </div>
            <div>
